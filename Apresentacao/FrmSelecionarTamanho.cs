...
{
    public partial class FrmSelecionarTamanho : Form
    {
        ...
        public FrmSelecionarTamanho([Optional] string nomeTamanho)
        {
            InitializeComponent();
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.tamanhoLista = nTamanho.BuscarTamanhoPorNome(tamanho);
            AtualizarDataGrid();
        }
        ...
        private void FrmSelecionarTamanho_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmSelecionarTamanho_Load(object sender, EventArgs e)
        {
            if (strTamanho != null)
            {
                tbBuscarTamanho.Text = strTamanho;
