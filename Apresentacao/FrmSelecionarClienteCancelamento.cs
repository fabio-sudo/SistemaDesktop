...
{
    public partial class FrmSelecionarClienteCancelamento : Form
    {
        ...
        public FrmSelecionarClienteCancelamento([Optional]string Cliente, string AVista, string Crediario, string CrediarioPago, string nomeFuncionario, string formaPagamento, DateTime dataInicial, DateTime dataFinal)
        {
            InitializeComponent();

            if (Cliente != String.Empty && Cliente != "Digite o nome do cliente ...")
            {
                strCliente = Cliente;
            }
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.clienteLista = nCliente.BuscarCancelamentoClientePorNome(strAVista, strCrediario, strCrediarioPago, clienteStr, strFuncionario, strformaPagamento, dtDataInicial, dtDataFinal);
            AtualizarDataGrid();
        }
        ...
        //---------------formulário
        private void FrmSelecionarClienteCancelamento_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmSelecionarClienteCancelamento_Load(object sender, EventArgs e)
        {
