...
{
    public partial class FrmSelecionarProdutoVenda : Form
    {
        //Objetos
        ...
        public FrmSelecionarProdutoVenda(int codigoVenda, string descricaoProduto, string strFrm)
        {
            InitializeComponent();

            intVenda = codigoVenda;
            strFormulario = strFrm;

            if (descricaoProduto != String.Empty)
            {
                strProduto = descricaoProduto;
            }
        }
        ...
        public void metodoExibeImagemProduto()
        {
            ...
            if (this.dgvProduto.Rows.Count > 0)
            {
                ...
                listaImagens = nProduto.BuscarImagensProdutoVenda(indiceSelecionado, intVenda);
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.ProdutoLista = nProduto.BuscarProdutoVendaPorNome(Strproduto, intVenda);
            AtualizarDataGrid();
        ...
        private void btSelecionar_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvProduto.RowCount > 0)
                {
                    ...
                    FrmProdutoCorVenda frmProdutoCor = new FrmProdutoCorVenda(ProdutoSelecionado, intVenda, strFormulario);
                    DialogResult resposta;
        ...
        //-----------------------Teclas de Atalho
        private void FrmSelecionarProdutoVenda_Load(object sender, EventArgs e)
        {
            tbBuscarProduto.Focus();
            //Buscal Local que a Solution Está sendo Executada no Computador
            string LocalSolution = Environment.CurrentDirectory;
            ...
            if (strProduto != null)
            {
                tbBuscarProduto.Text = strProduto;
                btBuscar.PerformClick();
            }
        }

        private void FrmSelecionarProdutoVenda_KeyDown(object sender, KeyEventArgs e)
        {
