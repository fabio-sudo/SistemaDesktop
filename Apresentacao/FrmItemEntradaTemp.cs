...
{
    public partial class FrmItemEntradaTemp : Form
    {
        ...
        public FrmItemEntradaTemp(ProdutoCor produtoCor, int codigoEntradaEstoque)
        {
            InitializeComponent();
        ...
        private void FrmItemEntradaTemp_Load(object sender, EventArgs e)
        {
        ...
        private void btSelecionar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow row in dgvTamnhoItem.Rows)
                {
                    ...
                    else if (Convert.ToInt32(row.Cells[0].Value) != 0 && item.quantidadeItem == 0)
                    {
                        //-----------Exclui item entrada para não ocupar espaço no banco de dados
                        if (nItem.ExcluirItemEntradaTemp(Convert.ToInt32(row.Cells[0].Value)) != true)
                        {
                ...
                {
                    if (nItem.CadastrarItemEntradaListaTemp(itemLista) == true)
                    {
                        DialogResult resposta;
                        //Criando Caixa de dialogo
        ...
        //-----------------------Formulário
        private void FrmItemEntradaTemp_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.DialogResult = DialogResult.Yes;
        }

        private void FrmItemEntradaTemp_KeyDown(object sender, KeyEventArgs e)
        {
