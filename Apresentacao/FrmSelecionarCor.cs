...
{
    public partial class FrmSelecionarCor : Form
    {
        ...
        public FrmSelecionarCor([Optional] string nomeCor)
        {
            InitializeComponent();
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.corLista = nCor.BuscarCorPorNome(strCor);
            AtualizarDataGrid();
        }
        ...
        private void FrmSelecionarCor_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmSelecionarCor_Load(object sender, EventArgs e)
        {
            if (strCor != null)
            {
                tbBuscarCor.Text = strCor;
