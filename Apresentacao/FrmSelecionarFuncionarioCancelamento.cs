...
{
    public partial class FrmSelecionarFuncionarioCancelamento : Form
    {
        ...
        DateTime dtDataFinal;


        public FrmSelecionarFuncionarioCancelamento([Optional]string nomeFuncionario, string AVista, string Crediario, string CrediarioPago, string nomeCliente, string sobrenomeCliente, string formaPagamento, DateTime dataInicial, DateTime dataFinal)
        {
            InitializeComponent();

            if (nomeFuncionario != String.Empty && nomeFuncionario != "Digite o nome do funcionário ...")
            {
                strFuncionario = nomeFuncionario;
            }

             strAVista = AVista;
             strCrediario = Crediario;
             strCrediarioPago = CrediarioPago;
             strnomeCliente = nomeCliente;
             strsobrenomeCliente = sobrenomeCliente;
             strformaPagamento = formaPagamento;
             dtDataInicial = dataInicial;
             dtDataFinal = dataFinal;
        }
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.FuncionarioLista = nFuncionario.BuscarCancelamentoFuncionarioPorNome(strAVista, strCrediario, strCrediarioPago, strnomeCliente, strsobrenomeCliente, funcionario, strformaPagamento, dtDataInicial, dtDataFinal);
            AtualizarDataGrid();
        }
        ...
        //--------------------------Atalhos
        private void FrmSelecionarFuncionarioCancelamento_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmSelecionarFuncionarioCancelamento_Load(object sender, EventArgs e)
        {
            if (strFuncionario != String.Empty)
            {
                tbBuscarFuncionario.Text = strFuncionario;
