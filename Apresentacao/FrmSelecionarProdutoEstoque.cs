...
{
    public partial class FrmSelecionarProdutoEstoque : Form
    {
        //Objetos
        ...
        public FrmSelecionarProdutoEstoque(int codigoEntradaEstoque, [Optional] string descricaoProduto, string strFrm)
        {
            InitializeComponent();
        ...
        private void btSelecionar_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvProduto.RowCount > 0)
                {
                    ...
                    FrmProdutoCorEntrada frmProdutoCor = new FrmProdutoCorEntrada(ProdutoSelecionado, codEntradaEstoque, strFormulario);
                    DialogResult resposta;
        ...
        //---------------------Teclas de Atalho
        private void FrmSelecionarProdutoEstoque_Load(object sender, EventArgs e)
        {
            tbBuscarProduto.Focus();
            //Buscal Local que a Solution Está sendo Executada no Computador
            string LocalSolution = Environment.CurrentDirectory;
        ...
        private void FrmSelecionarProdutoEstoque_KeyDown(object sender, KeyEventArgs e)
        {
