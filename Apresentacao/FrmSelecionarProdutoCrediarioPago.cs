...
{
    public partial class FrmSelecionarProdutoCrediarioPago : Form
    {
        ...
        public FrmSelecionarProdutoCrediarioPago(Crediario crediario, string descricaoProduto)
        {
            InitializeComponent();

            this.objCrediario = crediario;
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.listaProdutoCor = nProdutoCor.uspBuscarProdutoItemCrediarioPago(Strproduto, objCrediario.codigoCrediario);
            AtualizarDataGrid();
        ...
        //-------------Formulário
        private void FrmSelecionarProdutoCrediarioPago_KeyDown(object sender, KeyEventArgs e)
        {
